...
public class KafkaConfig {
    ...
    // Payment Events Topic Configuration
    ...
    public NewTopic paymentEventsTopic() {
        logger.info("Payment events topic configured: {}", PAYMENT_EVENTS_TOPIC);
    ...
    public String kafkaConfigurationInfo() {
        ...
        logger.info("Topics configured: {}, {}", PAYMENT_EVENTS_TOPIC, NOTIFICATION_EVENTS_TOPIC);
        return "Kafka configuration completed";
    }
}